...
link to the live website : https://flashify-dsa.onrender.com/
...
## 🚀 Deployment
The application was previously deployed on an **AWS EC2** instance and has been now migrated to render.  
👉 [Live Demo] https://flashify-dsa.onrender.com/
